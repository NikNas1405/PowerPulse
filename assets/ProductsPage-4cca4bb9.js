...
https://fb.me/react-async-component-lifecycle-hooks`)}if(typeof n.getDerivedStateFromProps=="function"&&(e.componentWillMount=_n,e.componentWillReceiveProps=$n),typeof e.getSnapshotBeforeUpdate=="function"){if(typeof e.componentDidUpdate!="function")throw new Error("Cannot polyfill getSnapshotBeforeUpdate() for components that do not define componentDidUpdate() on the prototype");e.componentWillUpdate=Bn;var s=e.componentDidUpdate;e.componentDidUpdate=function(l,c,d){var f=this.__reactInternalSnapshotFlag?this.__reactInternalSnapshot:d;s.call(this,l,c,f)}}return n}const Yi=Object.freeze(Object.defineProperty({__proto__:null,polyfill:Gi},Symbol.toStringTag,{value:"Module"})),Ki=Zn(Yi);Object.defineProperty(fe,"__esModule",{value:!0});fe.bodyOpenClassName=fe.portalClassName=void 0;var Gt=Object.assign||function(n){for(var e=1;e<arguments.length;e++){var o=arguments[e];for(var r in o)Object.prototype.hasOwnProperty.call(o,r)&&(n[r]=o[r])}return n},Xi=function(){function n(e,o){for(var r=0;r<o.length;r++){var t=o[r];t.enumerable=t.enumerable||!1,t.configurable=!0,"value"in t&&(t.writable=!0),Object.defineProperty(e,t.key,t)}}return function(e,o,r){return o&&n(e.prototype,o),r&&n(e,r),e}}(),Hn=v,We=Fe(Hn),Zi=tn,Ue=Fe(Zi),Ji=rn,R=Fe(Ji),Qi=qi,Yt=Fe(Qi),eu=oe,tu=ou(eu),ce=te,Kt=Fe(ce),nu=Ki;function ou(n){if(n&&n.__esModule)return n;var e={};if(n!=null)for(var o in n)Object.prototype.hasOwnProperty.call(n,o)&&(e[o]=n[o]);return e.default=n,e}function Fe(n){return n&&n.__esModule?n:{default:n}}function ru(n,e){if(!(n instanceof e))throw new TypeError("Cannot call a class as a function")}function Xt(n,e){if(!n)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return e&&(typeof e=="object"||typeof e=="function")?e:n}function au(n,e){if(typeof e!="function"&&e!==null)throw new TypeError("Super expression must either be null or a function, not "+typeof e);n.prototype=Object.create(e&&e.prototype,{constructor:{value:n,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(n,e):n.__proto__=e)}var iu=fe.portalClassName="ReactModalPortal",uu=fe.bodyOpenClassName="ReactModal__Body--open",de=ce.canUseDOM&&Ue.default.createPortal!==void 0,Zt=function(e){return document.createElement(e)},Jt=function(){return de?Ue.default.createPortal:Ue.default.unstable_renderSubtreeIntoContainer};function Ve(n){return n()}var De=function(n){au(e,n);function e(){var o,r,t,i;ru(this,e);for(var u=arguments.length,s=Array(u),a=0;a<u;a++)s[a]=arguments[a];return i=(r=(t=Xt(this,(o=e.__proto__||Object.getPrototypeOf(e)).call.apply(o,[this].concat(s))),t),t.removePortal=function(){!de&&Ue.default.unmountComponentAtNode(t.node);var l=Ve(t.props.parentSelector);l&&l.contains(t.node)?l.removeChild(t.node):console.warn('React-Modal: "parentSelector" prop did not returned any DOM element. Make sure that the parent element is unmounted to avoid any memory leaks.')},t.portalRef=function(l){t.portal=l},t.renderPortal=function(l){var c=Jt(),d=c(t,We.default.createElement(Yt.default,Gt({defaultStyles:e.defaultStyles},l)),t.node);t.portalRef(d)},r),Xt(t,i)}return Xi(e,[{key:"componentDidMount",value:function(){if(ce.canUseDOM){de||(this.node=Zt("div")),this.node.className=this.props.portalClassName;var r=Ve(this.props.parentSelector);r.appendChild(this.node),!de&&this.renderPortal(this.props)}}},{key:"getSnapshotBeforeUpdate",value:function(r){var t=Ve(r.parentSelector),i=Ve(this.props.parentSelector);return{prevParent:t,nextParent:i}}},{key:"componentDidUpdate",value:function(r,t,i){if(ce.canUseDOM){var u=this.props,s=u.isOpen,a=u.portalClassName;r.portalClassName!==a&&(this.node.className=a);var l=i.prevParent,c=i.nextParent;c!==l&&(l.removeChild(this.node),c.appendChild(this.node)),!(!r.isOpen&&!s)&&!de&&this.renderPortal(this.props)}}},{key:"componentWillUnmount",value:function(){if(!(!ce.canUseDOM||!this.node||!this.portal)){var r=this.portal.state,t=Date.now(),i=r.isOpen&&this.props.closeTimeoutMS&&(r.closesAt||t+this.props.closeTimeoutMS);i?(r.beforeClose||this.portal.closeWithTimeout(),setTimeout(this.removePortal,i-t)):this.removePortal()}}},{key:"render",value:function(){if(!ce.canUseDOM||!de)return null;!this.node&&de&&(this.node=Zt("div"));var r=Jt();return r(We.default.createElement(Yt.default,Gt({ref:this.portalRef,defaultStyles:e.defaultStyles},this.props)),this.node)}}],[{key:"setAppElement",value:function(r){tu.setElement(r)}}]),e}(Hn.Component);De.propTypes={isOpen:R.default.bool.isRequired,style:R.default.shape({content:R.default.object,overlay:R.default.object}),portalClassName:R.default.string,bodyOpenClassName:R.default.string,htmlOpenClassName:R.default.string,className:R.default.oneOfType([R.default.string,R.default.shape({base:R.default.string.isRequired,afterOpen:R.default.string.isRequired,beforeClose:R.default.string.isRequired})]),overlayClassName:R.default.oneOfType([R.default.string,R.default.shape({base:R.default.string.isRequired,afterOpen:R.default.string.isRequired,beforeClose:R.default.string.isRequired})]),appElement:R.default.oneOfType([R.default.instanceOf(Kt.default),R.default.instanceOf(ce.SafeHTMLCollection),R.default.instanceOf(ce.SafeNodeList),R.default.arrayOf(R.default.instanceOf(Kt.default))]),onAfterOpen:R.default.func,onRequestClose:R.default.func,closeTimeoutMS:R.default.number,ariaHideApp:R.default.bool,shouldFocusAfterRender:R.default.bool,shouldCloseOnOverlayClick:R.default.bool,shouldReturnFocusAfterClose:R.default.bool,preventScroll:R.default.bool,parentSelector:R.default.func,aria:R.default.object,data:R.default.object,role:R.default.string,contentLabel:R.default.string,shouldCloseOnEsc:R.default.bool,overlayRef:R.default.func,contentRef:R.default.func,id:R.default.string,overlayElement:R.default.func,contentElement:R.default.func};De.defaultProps={isOpen:!1,portalClassName:iu,bodyOpenClassName:uu,role:"dialog",ariaHideApp:!0,closeTimeoutMS:0,shouldFocusAfterRender:!0,shouldCloseOnEsc:!0,shouldCloseOnOverlayClick:!0,shouldReturnFocusAfterClose:!0,preventScroll:!1,parentSelector:function(){return document.body},overlayElement:function(e,o){return We.default.createElement("div",e,o)},contentElement:function(e,o){return We.default.createElement("div",e,o)}};De.defaultStyles={overlay:{position:"fixed",top:0,left:0,right:0,bottom:0,backgroundColor:"rgba(255, 255, 255, 0.75)"},content:{position:"absolute",top:"40px",left:"40px",right:"40px",bottom:"40px",border:"1px solid #ccc",background:"#fff",overflow:"auto",WebkitOverflowScrolling:"touch",borderRadius:"4px",outline:"none",padding:"20px"}};(0,nu.polyfill)(De);fe.default=De;(function(n,e){Object.defineProperty(e,"__esModule",{value:!0});var o=fe,r=t(o);function t(i){return i&&i.__esModule?i:{default:i}}e.default=r.default,n.exports=e.default})(rt,rt.exports);var su=rt.exports;const lu=Jn(su),cu=L.button`
  position: absolute;
  top: 14px;
  right: 14px;
  width: 22px;
...
`,du=({isOpen:n,onRequestClose:e,children:o})=>{const[r,t]=v.useState(n);v.useEffect(()=>(r?document.body.style.overflow="hidden":document.body.style.overflow="visible",()=>{document.body.style.overflow="visible"}),[r]);const i=()=>{t(!1),e&&e()},u={overlay:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",display:"flex",justifyContent:"center",alignItems:"center",backgroundColor:"rgba(18, 20, 23, 0.50)",zIndex:1e3,overflow:"auto"},content:{maxWidth:"fit-content",maxHeight:"fit-content",margin:"auto",overflow:"auto",inset:0,border:"none",background:"none",padding:0}};return x.jsxs(lu,{isOpen:r,onRequestClose:i,shouldCloseOnOverlayClick:!0,shouldCloseOnEsc:!0,ariaHideApp:!1,style:u,children:[x.jsx(cu,{type:"button",onClick:i,children:x.jsx("svg",{children:x.jsx("use",{href:ue+"#icon-x"})})}),o]})},pu="/PowerPulse/assets/avocado-46dd5bc9.png",fu=L.div`
  display: flex;
...
`,xu=({calories:n,closeModalAddProductSuccess:e})=>x.jsxs(fu,{children:[x.jsx(hu,{}),x.jsx(mu,{children:"Well done"}),x.jsxs(vu,{children:[x.jsx("span",{children:"Calories: "}),n]}),x.jsx(gu,{type:"button",onClick:e,children:"Next product"}),x.jsxs(bu,{to:"/diary",onClick:e,children:["To the diary",x.jsx("svg",{children:x.jsx("use",{href:ue+"#icon-arrow"})})]})]}),Eu=L.form`
  width: 335px;
  height: 280px;
  padding: 48px 24px;
  background: #10100f;
...
`,Iu=({closeModallAddProductForm:n,onClick:e,productTitle:o,calories:r,productId:t})=>{const i=lt(),[u,s]=v.useState({product:"",date:"",amount:"",calories:""}),[a,l]=v.useState(""),[c,d]=v.useState(""),[f,h]=v.useState(!1),g=new Date,E=String(g.getDate()).padStart(2,"0"),m=String(g.getMonth()+1).padStart(2,"0"),b=g.getFullYear(),C=`${E}-${m}-${b}`,S=o[0].toUpperCase()+o.slice(1).toLowerCase(),M=async T=>{if(T.preventDefault(),(0>=u.amount||3e3<=u.amount)&&u.amount)d("Entering value must be at range 1g to 3000g"),h(!0),l(r);else if(Object.keys(u).length<0||u.amount==="")d("Enter amount*"),h(!0);else{d(""),h(!1);try{n(),e(u.calories),await i(eo(u))}catch(_){nn.error("Network error:",_)}}},V=T=>{const _=parseFloat(T.target.value),I=parseFloat(r);if(!isNaN(_)&&!isNaN(I)){const $=Math.round(_*I/100);l($),s({productId:t,date:C,amount:_,calories:$}),d(""),h(!1)}else l(r),s({productId:"",date:"",amount:"",calories:""})};return x.jsxs(Eu,{onSubmit:M,noValidate:!0,children:[x.jsxs(Cu,{children:[x.jsx(yu,{children:S}),x.jsxs(wu,{children:[x.jsx(Ou,{htmlFor:"calories",children:"grams"}),x.jsx(Su,{type:"number",name:"calories",placeholder:"100",autoComplete:"off",required:!0,step:"1",min:"1",max:"3000",onChange:V}),f&&x.jsxs(Fu,{children:[x.jsx("svg",{children:x.jsx("use",{href:ue+"#icon-checkbox-circle-fill"})}),c]})]})]}),a?x.jsxs(Qt,{children:[x.jsx("span",{children:"Calories: "}),a]}):x.jsxs(Qt,{children:[x.jsx("span",{children:"Calories: "}),r]}),x.jsxs(Du,{children:[x.jsx(Mu,{type:"submit",children:"Add to diary"}),x.jsx(Au,{type:"button",onClick:()=>{n()},children:"Cancel"})]})]})},Pu=L.li`
  width: 335px;
  position: relative;
  display: flex;
  flex-direction: column;
...
`,$u=({product:n,type:e,handleOpenModal:o})=>{const r=d=>[...d.map(f=>f[0].toUpperCase()+f.slice(1).toLowerCase())],{title:t,category:i,calories:u,weight:s}=n,a=r([t])[0],l=r([i])[0];let c;return e?c="Recommended":c="Not recommended",x.jsxs(Pu,{children:[x.jsx(Ru,{children:"DIET"}),x.jsxs("div",{style:{display:"flex",gap:"16px",alignSelf:"flex-end",flexWrap:"wrap"},children:[x.jsxs("div",{style:{display:"flex",gap:"8px",alignItems:"center"},children:[x.jsx(en,{children:e?x.jsx("use",{href:ue+"#icon-Ellipse-82",style:{fill:y.colorSecondaryGreen,stroke:y.colorSecondaryGreen}}):x.jsx("use",{href:ue+"#icon-Ellipse-82",style:{fill:y.colorSecondaryRed,stroke:y.colorSecondaryRed}})}),x.jsx(et,{children:c})]}),x.jsxs(Tu,{onClick:()=>o(n),children:["Add",x.jsx(en,{style:{width:"16px",height:"16px"},children:x.jsx("use",{href:ue+"#icon-arrow",style:{stroke:y.colorOrange}})})]})]}),x.jsxs(ku,{children:[x.jsx("svg",{style:{flexShrink:0,width:"24px",height:"24px"},children:x.jsx("use",{href:ue+"#icon-running-stick-figure-svgrepo-com-1"})}),x.jsx(Lu,{children:a})]}),x.jsxs(_u,{children:[x.jsxs(et,{children:[x.jsx("span",{children:"Calories:"}),u]}),x.jsxs(Vu,{children:[x.jsx("span",{children:"Category:"}),l]}),x.jsxs(et,{children:[x.jsx("span",{children:"Weight:"}),s]})]})]})},Bu=n=>n.products.productsArray,Hu=n=>n.products.productsCategories,Nn=n=>n.products.isLoading,Nu=L.ul`
  width: 100%;
  display: flex;
  flex-wrap: wrap;
  gap: 20px;
...
`,zu=({products:n})=>{const e=Le(Nn),[o,r]=v.useState(null),[t,i]=v.useState(!1),[u,s]=v.useState(null),a=d=>{i(!0),r(d),s(d)},l=()=>{t&&i(!1),r(null),s(null)},c=1;return x.jsxs(x.Fragment,{children:[e&&x.jsx(ct,{}),!e&&n.length>0&&x.jsx(Nu,{children:n.map(d=>x.jsx($u,{product:d,type:d.groupBloodNotAllowed[c],handleOpenModal:a},d._id))}),!e&&n.length<=0&&x.jsxs(ju,{children:[x.jsxs(Wu,{children:[x.jsx("span",{children:"Sorry, no results were found"})," for the product filters you selected. You may want to consider other search options to find the product you want. Our range is wide and you have the opportunity to find more options that suit your needs."]}),x.jsx(Uu,{children:"Try changing the search parameters."})]}),o&&x.jsx(du,{isOpen:t,onRequestClose:l,children:typeof u=="object"?x.jsx(Iu,{closeModallAddProductForm:l,calories:o.calories,productTitle:o.title,productId:o._id,product:u,onClick:a}):x.jsx(xu,{calories:u,closeModalAddProductSuccess:l})})]})},qu="/PowerPulse/assets/products-bg-b7e77cea.jpg",Gu="/PowerPulse/assets/products-bg@2x-9876be0a.jpg",Yu=L.div`
  padding: 40px 0 80px;
  display: flex;
  flex-direction: column;
  gap: 40px;
...
`,ts=()=>{const n=lt(),e=Le(Nn),o=Le(Hu),r=Le(Bu);return v.useEffect(()=>{(async()=>{try{await n(Ee({title:"",category:null,filter:"all"}))}catch(i){nn.error("Error fetching data:",i),console.error("Error fetching data:",i)}})()},[n]),v.useEffect(()=>{n(to())},[n]),x.jsxs(Yu,{children:[x.jsxs(Ku,{children:[x.jsx(no,{title:"Products Page"}),x.jsx(ri,{categories:o.map(t=>t.title)})]}),e?x.jsx(ct,{}):x.jsx(Xu,{children:x.jsx(zu,{products:r})})]})};export{ts as default};
