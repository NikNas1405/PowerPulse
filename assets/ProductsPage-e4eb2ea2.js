...
`,Bu=({product:n,type:e,handleOpenModal:o})=>{const r=d=>[...d.map(f=>f[0].toUpperCase()+f.slice(1).toLowerCase())],{title:t,category:i,calories:u,weight:s}=n,a=r([t])[0],l=r([i])[0];let c;return e?c="Recommended":c="Not recommended",x.jsxs(Ru,{children:[x.jsx(Vu,{children:"DIET"}),x.jsxs("div",{style:{display:"flex",gap:"16px",alignSelf:"flex-end",flexWrap:"wrap"},children:[x.jsxs("div",{style:{display:"flex",gap:"8px",alignItems:"center"},children:[x.jsx(en,{children:e?x.jsx("use",{href:ue+"#icon-Ellipse-82",style:{fill:y.colorSecondaryGreen,stroke:y.colorSecondaryGreen}}):x.jsx("use",{href:ue+"#icon-Ellipse-82",style:{fill:y.colorSecondaryRed,stroke:y.colorSecondaryRed}})}),x.jsx(et,{children:c})]}),x.jsxs(ku,{onClick:()=>o(n),children:["Add",x.jsx(en,{style:{width:"16px",height:"16px"},children:x.jsx("use",{href:ue+"#icon-arrow",style:{stroke:y.colorOrange}})})]})]}),x.jsxs(_u,{children:[x.jsx("svg",{style:{flexShrink:0,width:"24px",height:"24px"},children:x.jsx("use",{href:ue+"#icon-running-stick-figure-svgrepo-com-1"})}),x.jsx(Tu,{children:a})]}),x.jsxs($u,{children:[x.jsxs(et,{children:[x.jsx("span",{children:"Calories:"}),u]}),x.jsxs(Lu,{children:[x.jsx("span",{children:"Category:"}),l]}),x.jsxs(et,{children:[x.jsx("span",{children:"Weight:"}),s]})]})]})},Hu=n=>n.products.productsArray,Nu=n=>n.products.productsCategories,Nn=n=>n.products.isLoading,ju=L.ul`
  width: 100%;
  display: flex;
  flex-wrap: wrap;
  gap: 20px;
...
`,qu=({products:n})=>{const e=Le(Nn),[o,r]=v.useState(null),[t,i]=v.useState(!1),[u,s]=v.useState(null),a=d=>{i(!0),r(d),s(d)},l=()=>{t&&i(!1),r(null),s(null)},c=1;return x.jsxs(x.Fragment,{children:[e&&x.jsx(ct,{}),!e&&n.length>0&&x.jsx(ju,{children:n.map(d=>x.jsx(Bu,{product:d,type:d.groupBloodNotAllowed[c],handleOpenModal:a},d._id))}),!e&&n.length<=0&&x.jsxs(Wu,{children:[x.jsxs(Uu,{children:[x.jsx("span",{children:"Sorry, no results were found"})," for the product filters you selected. You may want to consider other search options to find the product you want. Our range is wide and you have the opportunity to find more options that suit your needs."]}),x.jsx(zu,{children:"Try changing the search parameters."})]}),o&&x.jsx(pu,{isOpen:t,onRequestClose:l,children:typeof u=="object"?x.jsx(Pu,{closeModallAddProductForm:l,calories:o.calories,productTitle:o.title,productId:o._id,product:u,onClick:a}):x.jsx(Eu,{calories:u,closeModalAddProductSuccess:l})})]})},Gu="/PowerPulse/assets/products-bg-b7e77cea.jpg",Yu="/PowerPulse/assets/products-bg@2x-9876be0a.jpg",Ku=L.div`
  display: flex;
  flex-direction: column;
  gap: 40px;
  height: 100vh;
...
`,ns=()=>{const n=lt(),e=Le(Nn),o=Le(Nu),r=Le(Hu);return v.useEffect(()=>{(async()=>{try{await n(Ee({title:"",category:null,filter:"all"}))}catch(i){nn.error("Error fetching data:",i),console.error("Error fetching data:",i)}})()},[n]),v.useEffect(()=>{n(to())},[n]),x.jsx(Ku,{children:x.jsxs(no,{children:[x.jsxs(Xu,{children:[x.jsx(oo,{title:"Products Page"}),x.jsx(ai,{categories:o.map(t=>t.title)})]}),e?x.jsx(ct,{}):x.jsx(Zu,{children:x.jsx(qu,{products:r})})]})})};export{ns as default};
