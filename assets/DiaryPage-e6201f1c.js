import{j as e,h as R,s as i,g as t,r as $,a as r,u as N,e as S,i as A,k as H,N as B,m as _,o as L,Q as M,C as G,p as F}from"./index-1223d80d.js";import{W as U,e as Y,f as Q,a as P,s as V,b as q}from"./StyledDatepicker.styled-fa7c4df3.js";import{T as J}from"./TitlePage-e455acb2.js";import"./warning-9b42d5e6.js";const K=({selectedDate:o,setSelectedDate:p,isOpen:s,onClose:g,setCurrentDate:x})=>{const d=c=>{p(c),x(c),g()};return e.jsxs(U,{children:[e.jsx(Y,{selected:o,dateFormat:"dd/MM/yyyy",calendarStartDay:1,formatWeekDay:c=>c.substr(0,1),open:s,customInput:e.jsx("div",{style:{display:"none"}}),onChange:d}),e.jsx(R,{})]})},X=i.div`
  position: relative;
  display: flex;
  align-items: center;
