...
`,Hu=k.div`
  ...
  margin-top: 8px;
  align-items: center;
`,Nu=({product:n,type:e,handleOpenModal:o})=>{const r=d=>[...d.map(f=>f[0].toUpperCase()+f.slice(1).toLowerCase())],{title:t,category:i,calories:u,weight:s}=n,a=r([t])[0],l=r([i])[0];let c;return e?c="Recommended":c="Not recommended",b.jsxs(Lu,{children:[b.jsx(Tu,{children:"DIET"}),b.jsxs("div",{style:{display:"flex",gap:"16px",alignSelf:"flex-end",flexWrap:"wrap"},children:[b.jsxs("div",{style:{display:"flex",gap:"8px",alignItems:"center"},children:[b.jsx(en,{children:e?b.jsx("use",{href:ie+"#icon-Ellipse-82",style:{fill:C.colorSecondaryGreen,stroke:C.colorSecondaryGreen}}):b.jsx("use",{href:ie+"#icon-Ellipse-82",style:{fill:C.colorSecondaryRed,stroke:C.colorSecondaryRed}})}),b.jsx(et,{children:c})]}),b.jsxs($u,{onClick:()=>o(n),children:["Add",b.jsx(en,{style:{width:"16px",height:"16px"},children:b.jsx("use",{href:ie+"#icon-arrow",style:{stroke:C.colorOrange}})})]})]}),b.jsxs(Bu,{children:[b.jsx("svg",{style:{flexShrink:0,width:"24px",height:"24px"},children:b.jsx("use",{href:ie+"#icon-running-stick-figure-svgrepo-com-1"})}),b.jsx(_u,{children:a})]}),b.jsxs(Hu,{children:[b.jsxs(et,{children:[b.jsx("span",{children:"Calories:"}),u]}),b.jsxs(ku,{children:[b.jsx("span",{children:"Category:"}),l]}),b.jsxs(et,{children:[b.jsx("span",{children:"Weight:"}),s]})]})]})},ju=n=>n.products.productsArray,Uu=n=>n.products.productsCategories,Nn=n=>n.products.isLoadingProducts,Wu=n=>n.products.isLoadingProductsCategories,zu=k.ul`
  width: 100%;
  display: flex;
  flex-wrap: wrap;
  gap: 20px;
...
`,Ku=({products:n})=>{const e=me(Nn),[o,r]=v.useState(null),[t,i]=v.useState(!1),[u,s]=v.useState(null),a=f=>{i(!0),r(f),s(f)},l=()=>{t&&i(!1),r(null),s(null)},d=me(to).blood;return b.jsxs(b.Fragment,{children:[e&&b.jsx(ct,{}),!e&&n.length>0&&b.jsx(zu,{children:n.map(f=>b.jsx(Nu,{product:f,type:f.groupBloodNotAllowed[d],handleOpenModal:a},f._id))}),!e&&n.length<=0&&b.jsxs(qu,{children:[b.jsxs(Gu,{children:[b.jsx("span",{children:"Sorry, no results were found"})," for the product filters you selected. You may want to consider other search options to find the product you want. Our range is wide and you have the opportunity to find more options that suit your needs."]}),b.jsx(Yu,{children:"Try changing the search parameters."})]}),o&&b.jsx(hu,{isOpen:t,onRequestClose:l,children:typeof u=="object"?b.jsx(Vu,{closeModallAddProductForm:l,calories:o.calories,productTitle:o.title,productId:o._id,product:u,onClick:a}):b.jsx(yu,{calories:u,closeModalAddProductSuccess:l})})]})},Xu="/PowerPulse/assets/products-bg-b7e77cea.jpg",Zu="/PowerPulse/assets/products-bg@2x-9876be0a.jpg",Ju=k.div`
  display: flex;
  flex-direction: column;
  gap: 40px;
  height: 100vh;
...
`,as=()=>{const n=lt(),e=me(Nn);me(Wu);const o=me(Uu),r=me(ju);return v.useEffect(()=>{(async()=>{try{await n(Ce({title:"",category:void 0,filter:"all"}))}catch(i){nn.error("Error fetching data:",i),console.error("Error fetching data:",i)}})()},[n]),v.useEffect(()=>{n(no())},[n]),b.jsx(Ju,{children:b.jsxs(oo,{children:[b.jsxs(Qu,{children:[b.jsx(ro,{title:"Products Page"}),b.jsx(ui,{categories:o.map(t=>t.title)})]}),e?b.jsx(ct,{}):b.jsx(es,{children:b.jsx(Ku,{products:r})})]})})};export{as as default};
